 ...
 * Manter em sync com `src/lib/lztItemGuards.ts`.
 */
...
/**
 * `buyer` preenchido de forma significativa (conta já vendida).
 * Objeto vazio `{}` não conta — evita falsos positivos em payloads estranhos.
 */
