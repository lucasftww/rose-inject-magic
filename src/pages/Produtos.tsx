...
import squadCharNormal from "@/assets/games/squad-normal.webp";
import squadCharHover from "@/assets/games/squad-hover.webp";
...
import bodycamNormal from "@/assets/games/bodycam-normal.webp";
import bodycamHover from "@/assets/games/bodycam-hover.webp";
import bgCardBodycam from "@/assets/games/bg-card-bodycam.webp";
import warfaceNormal from "@/assets/games/warface-normal.webp";
import warfaceHover from "@/assets/games/warface-hover.webp";
import bgCardWarface from "@/assets/games/bg-card-warface.webp";
import bloodhuntNormal from "@/assets/games/bloodhunt-normal.webp";
import bloodhuntHover from "@/assets/games/bloodhunt-hover.webp";
import bgCardBloodhunt from "@/assets/games/bg-card-bloodhunt.webp";
...
import spoofersNormal from "@/assets/games/spoofers-normal.webp";
import spoofersHover from "@/assets/games/spoofers-hover.webp";
import bgCardSpoofers from "@/assets/games/bg-card-spoofers.webp";
  ...
  const loadProductsForGame = useCallback(async (gameId: string) => {
    ...
    try {
      const { data, error } = await supabase
        .from("products")
        .select("id, name, description, image_url, active, sort_order, game_id, created_at, status, status_label, status_updated_at, features_text, robot_game_id, robot_markup_percent, product_plans(*)")
        .eq("game_id", gameId)
        .eq("active", true)
