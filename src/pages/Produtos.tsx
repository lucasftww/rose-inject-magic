...
const ProductCard = ({ product }: { product: ProductFromDB }) => {
  ...
  return (
    <div
      ...
      className="cursor-pointer overflow-hidden rounded-lg border border-border bg-card transition-all hover:border-success/40 hover:shadow-[0_0_20px_hsl(130,99%,41%,0.1)]"
    >
