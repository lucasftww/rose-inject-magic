...
const STATIC_REVIEWS: Review[] = [
  ...
  { id: "s3", rating: 5, comment: "produto indetectavel mesmo, to usando faz 3 semanas e 0 problemas", created_at: "2026-03-10T07:55:00Z", user_id: "s", username: "rafael", product_name: "Cyclo Aim" },
  // 09/03
  ...
  { id: "s8", rating: 5, comment: "ja comprei 3 vezes aqui e nunca tive problema. loja confiavel demais", created_at: "2026-03-09T12:50:00Z", user_id: "s", username: "jorge", product_name: "Exclusive VAL" },
  ...
  { id: "s10", rating: 5, comment: "mlk o aim ta suave demais, parece q eu nasci jogando kkkkkk", created_at: "2026-03-09T08:30:00Z", user_id: "s", username: "enzo", product_name: "Arduino Aim" },
  // 08/03
  { id: "s11", rating: 5, comment: "tava com medo de ser scam mas entregaram tudo certinho. confiavel", created_at: "2026-03-08T23:15:00Z", user_id: "s", username: "ana", product_name: "Cyclo Aim" },
  ...
  { id: "s14", rating: 4, comment: "produto muito bom, so achei o tutorial meio confuso no inicio", created_at: "2026-03-08T16:25:00Z", user_id: "s", username: "leonardo", product_name: "Color bot" },
  ...
  { id: "s18", rating: 5, comment: "to usando faz 1 mes e zero deteccao, produto de qualidade real", created_at: "2026-03-08T07:20:00Z", user_id: "s", username: "vinicius", product_name: "Arduino Aim" },
  // 07/03
  ...
  { id: "s20", rating: 4, comment: "bom custo beneficio, so podia ter desconto pra quem compra de novo", created_at: "2026-03-07T20:30:00Z", user_id: "s", username: "ryan", product_name: "Cyclo Aim" },
  ...
  { id: "s22", rating: 5, comment: "nunca vi uma loja tao organizada, tutorial claro, suporte rapido. parabens", created_at: "2026-03-07T15:45:00Z", user_id: "s", username: "isadora", product_name: "Exclusive VAL" },
  { id: "s23", rating: 5, comment: "peguei 26 mil jogos na steam por um preco ridiculo, vale muito a pena", created_at: "2026-03-07T13:20:00Z", user_id: "s", username: "ricardo", product_name: "26 MIL JOGOS NA SUA STEAM" },
  ...
  // 06/03
  { id: "s27", rating: 5, comment: "irmao essa loja e diferenciada, qualidade absurda em tudo", created_at: "2026-03-06T23:30:00Z", user_id: "s", username: "samuel", product_name: "Arduino Aim" },
  ...
  { id: "s30", rating: 5, comment: "comprei de madrugada e o suporte me respondeu msm assim. top demais", created_at: "2026-03-06T16:40:00Z", user_id: "s", username: "caio", product_name: "Cyclo Aim" },
  ...
  { id: "s33", rating: 5, comment: "cheguei imortal em 2 semanas usando, sem ban nenhum ate agr", created_at: "2026-03-06T09:30:00Z", user_id: "s", username: "joao", product_name: "Exclusive VAL" },
  ...
  // 05/03
  { id: "s35", rating: 5, comment: "meu duo ficou maluco quando viu minha mira kkkk valeu royal", created_at: "2026-03-05T22:45:00Z", user_id: "s", username: "leo", product_name: "Arduino Aim" },
  { id: "s36", rating: 5, comment: "confiavel, rapido e barato. trifeta completa", created_at: "2026-03-05T20:30:00Z", user_id: "s", username: "amanda", product_name: "Color bot" },
  ...
  { id: "s38", rating: 5, comment: "loja seria demais, paguei e em 2 min ja tava com tudo configurado", created_at: "2026-03-05T15:50:00Z", user_id: "s", username: "marcelo", product_name: "Exclusive VAL" },
  ...
  { id: "s40", rating: 5, comment: "cara o aim assist desse negocio e surreal, minha kda subiu absurdo", created_at: "2026-03-05T11:00:00Z", user_id: "s", username: "renan", product_name: "Arduino Aim" },
  { id: "s41", rating: 5, comment: "recomendo pra qualquer um, funciona de verdade e o suporte e gente boa", created_at: "2026-03-05T09:15:00Z", user_id: "s", username: "beatriz", product_name: "Color bot" },
  ...
  { id: "s44", rating: 5, comment: "melhor compra que ja fiz na vida kkkk to destruindo nas ranked", created_at: "2026-03-04T21:00:00Z", user_id: "s", username: "rodrigo", product_name: "Exclusive VAL" },
  { id: "s45", rating: 4, comment: "demorou umas horas pra ativar mas depois funcionou perfeitamente", created_at: "2026-03-04T18:45:00Z", user_id: "s", username: "fernanda", product_name: "Cyclo Aim" },
  ...
  { id: "s47", rating: 5, comment: "peguei o esp only e ja consigo prever todo mundo, jogo ficou facil demais", created_at: "2026-03-04T14:00:00Z", user_id: "s", username: "bruno", product_name: "Esp Only" },
  { id: "s48", rating: 5, comment: "minha namorada comprou pra mim de presente kkkk ela achou a loja confiavel", created_at: "2026-03-04T11:35:00Z", user_id: "s", username: "diego", product_name: "Exclusive VAL" },
  { id: "s49", rating: 5, comment: "cara nunca tomei ban usando, ja faz quase 2 meses. produto solido", created_at: "2026-03-04T09:10:00Z", user_id: "s", username: "gustavo", product_name: "Arduino Aim" },
  ...
  // 03/03
  { id: "s51", rating: 5, comment: "to indicando pra todo mundo do meu grupo, todos compraram e gostaram", created_at: "2026-03-03T22:55:00Z", user_id: "s", username: "daniel", product_name: "Color bot" },
  { id: "s52", rating: 4, comment: "achei o preco um pouco alto mas a qualidade compensa demais", created_at: "2026-03-03T20:40:00Z", user_id: "s", username: "luan", product_name: "Exclusive VAL" },
  ...
  { id: "s54", rating: 5, comment: "comprei no pix e chegou instantaneo, nem acreditei na velocidade", created_at: "2026-03-03T15:50:00Z", user_id: "s", username: "bianca", product_name: "Esp Aim" },
  { id: "s55", rating: 5, comment: "uso o arduino aim desde q lancou e nunca me deu problema nenhum", created_at: "2026-03-03T13:30:00Z", user_id: "s", username: "wendel", product_name: "Arduino Aim" },
  { id: "s56", rating: 5, comment: "a royal e a unica loja q eu confio pra comprar essas coisas, nunca falha", created_at: "2026-03-03T11:10:00Z", user_id: "s", username: "kaique", product_name: "Cyclo Aim" },
  { id: "s57", rating: 5, comment: "comprei o oneclick e desbaniu minha conta principal, salvou demais", created_at: "2026-03-03T09:00:00Z", user_id: "s", username: "mariana", product_name: "Oneclick" },
  ...
  { id: "s60", rating: 5, comment: "terceira vez comprando aqui, sempre entrega rapido e funciona certinho", created_at: "2026-03-02T21:20:00Z", user_id: "s", username: "clara", product_name: "Exclusive VAL" },
  ...
  { id: "s67", rating: 5, comment: "comprei a conta e ja entrei jogando comp, tudo certo e funcionando", created_at: "2026-03-02T06:30:00Z", user_id: "s", username: "isabella", product_name: "Contas Valorant" },
  ...
  { id: "s69", rating: 5, comment: "irmao paguei barato e o negocio funciona melhor q coisa de 200 conto", created_at: "2026-03-02T02:50:00Z", user_id: "s", username: "danilo", product_name: "Esp Aim" },
  { id: "s70", rating: 4, comment: "bom produto, tive q pedir ajuda pro suporte mas resolveram rapido", created_at: "2026-03-02T01:10:00Z", user_id: "s", username: "patricia", product_name: "Arduino Aim" },
  // extras espalhados entre 02-10
  { id: "s71", rating: 5, comment: "ja indiquei pra uns 10 amigos, todos compraram e aprovaram", created_at: "2026-03-09T19:00:00Z", user_id: "s", username: "helena", product_name: "Exclusive VAL" },
  { id: "s72", rating: 5, comment: "26 mil jogos na steam por esse preco e surreal, melhor compra", created_at: "2026-03-08T20:10:00Z", user_id: "s", username: "bryan", product_name: "26 MIL JOGOS NA SUA STEAM" },
  ...
  { id: "s75", rating: 5, comment: "loja confiavel demais, paguei e recebi na hora. sem enrolacao", created_at: "2026-03-05T21:55:00Z", user_id: "s", username: "valentina", product_name: "Oneclick" },
  ...
  { id: "s77", rating: 4, comment: "gostei bastante, so achei a interface um pouco complicada no comeco", created_at: "2026-03-03T19:40:00Z", user_id: "s", username: "lara", product_name: "Cyclo Aim" },
  ...
  { id: "s80", rating: 5, comment: "spoofer resolveu o ban do meu note e do meu pc de mesa, os dois", created_at: "2026-03-04T15:05:00Z", user_id: "s", username: "cecilia", product_name: "Spoofer games" },
];
