          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
            <div className="md:col-span-1">
              ...
              <div className="mt-4 flex gap-3">
                <a href="https://discord.gg/FeJ5JAZFmU" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-full border border-border text-muted-foreground transition-colors hover:border-success hover:text-success">
