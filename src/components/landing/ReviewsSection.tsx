    ...
    <section className="border-t border-border bg-background px-4 sm:px-6 py-12 sm:py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-5 sm:hidden">
          <div className="flex gap-2.5 overflow-x-auto scrollbar-hide pb-3 -mx-4 px-4 snap-x snap-mandatory">
          ...
          <div className="flex justify-center mt-2">
            <Link to="/avaliacoes" className="text-[10px] font-medium text-success">{t("reviews.viewAll")}</Link>
          </div>
        </div>

        {/* Desktop grid */}
        <motion.div
          className="mt-12 hidden sm:grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3"
