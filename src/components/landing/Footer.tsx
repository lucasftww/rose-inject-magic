    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-2 gap-8 sm:gap-12 md:grid-cols-4">
          ...
          <div>
            <h4 className="text-xs sm:text-sm font-bold uppercase tracking-wider text-foreground">{t("footer.productsTitle")}</h4>
            <ul className="mt-3 sm:mt-4 space-y-2">
              <li><Link to="/produtos" className="text-xs sm:text-sm text-muted-foreground transition-colors hover:text-success">{t("footer.softwareLink")}</Link></li>
              <li><Link to="/contas" className="text-xs sm:text-sm text-muted-foreground transition-colors hover:text-success">{t("footer.valorantAccounts")}</Link></li>
              <li><Link to="/produtos" className="text-xs sm:text-sm text-muted-foreground transition-colors hover:text-success">{t("footer.premiumSkins")}</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-xs sm:text-sm font-bold uppercase tracking-wider text-foreground">{t("footer.supportTitle")}</h4>
            <ul className="mt-3 sm:mt-4 space-y-2">
              <li><Link to="/ajuda" className="text-xs sm:text-sm text-muted-foreground transition-colors hover:text-success">{t("footer.helpCenter")}</Link></li>
              ...
              <li><Link to="/garantia" className="text-xs sm:text-sm text-muted-foreground transition-colors hover:text-success">{t("footer.warranty")}</Link></li>
              <li><Link to="/status" className="text-xs sm:text-sm text-muted-foreground transition-colors hover:text-success">{t("nav.status")}</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-xs sm:text-sm font-bold uppercase tracking-wider text-foreground">{t("footer.legalTitle")}</h4>
            <ul className="mt-3 sm:mt-4 space-y-2">
              <li><Link to="/termos" className="text-xs sm:text-sm text-muted-foreground transition-colors hover:text-success">{t("footer.termsOfUse")}</Link></li>
              <li><Link to="/privacidade" className="text-xs sm:text-sm text-muted-foreground transition-colors hover:text-success">{t("footer.privacy")}</Link></li>
              <li><Link to="/reembolso" className="text-xs sm:text-sm text-muted-foreground transition-colors hover:text-success">{t("footer.refund")}</Link></li>
            </ul>
          </div>
        </div>
