    ...
    <section className="border-t border-border bg-background px-5 sm:px-6 py-14 sm:py-32 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <div className="mt-7 sm:mt-10 flex flex-col sm:flex-row justify-center gap-3 px-2 sm:px-0">
          <Link
            to="/produtos"
            className="touch-manipulation flex items-center justify-center gap-2 bg-success px-8 sm:px-10 py-3.5 sm:py-4 text-xs sm:text-sm font-bold uppercase tracking-[0.2em] text-success-foreground rounded-2xl sm:rounded-xl shadow-[0_4px_24px_hsl(197,100%,50%,0.25)]"
            style={{ fontFamily: "'Valorant', sans-serif" }}
          >
            {t("cta.viewProducts")}
          ...
          <Link
            to="/contas"
            className="touch-manipulation flex items-center justify-center gap-2 border-2 border-foreground/20 px-8 sm:px-10 py-3.5 sm:py-4 text-xs sm:text-sm font-bold uppercase tracking-[0.25em] text-foreground transition-all hover:border-success hover:text-success rounded-2xl sm:rounded-xl"
            style={{ fontFamily: "'Valorant', sans-serif" }}
          >
