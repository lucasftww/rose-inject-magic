  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <button
          onClick={generatePDF}
          className="flex items-center gap-2 rounded-lg border border-border bg-card px-4 py-2 text-xs font-medium text-muted-foreground hover:text-foreground hover:border-success/30 transition-colors"
        >
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-lg border border-success/30 bg-success/5 p-5">
          ...
          <p className="text-[10px] text-muted-foreground mt-1">{payments.length + lztSales.length} total transações</p>
        </div>
      </div>
